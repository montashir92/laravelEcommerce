          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="{{ route('categories.index') }}" class="btn btn-success btn-sm float-right"><i class="fas fa-list"></i> Category List</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  <form action="{{ (@$editData) ? route('categories.update', $editData->id) : route('categories.store') }}" method="post" id="myForm" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-5">
                          <select class="form-control" name="parent_id" id="parent_id">
                              ...
                              <option value="{{ $category->id }}" {{ ($category->id == @$editData->parent_id) ? 'selected' : '' }}>{{ $category->name }}</option>
                              @endforeach
                          </select>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-2">
                          <img src="{{ asset('images/categories/'.@$editData->image) }}" width="100" id="showImage" alt="">
                      </div>
                    </div>
